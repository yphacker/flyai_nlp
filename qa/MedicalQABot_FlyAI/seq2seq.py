...
class Seq2Seq(object):
    ...
    def __init__(self, batch_size, encoder_vocab_size, decoder_vocab_size, mode):
        """
        初始化函数
        """
        ...
        self.max_decode_step = model_config.max_decode_step
        self.max_gradient_norm = model_config.max_gradient_norm
        self.learning_rate = model_config.learning_rate
        self.decay_step = model_config.decay_step
        self.min_learning_rate = model_config.min_learning_rate
        self.bidirection = model_config.bidirection
    ...
    def predict_batch(self, sess, encoder_inputs, encoder_inputs_length):
        """
        预测
        :return:
        """
